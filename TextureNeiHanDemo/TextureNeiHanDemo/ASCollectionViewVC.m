...
@interface ASCollectionViewVC () <ASCollectionDataSource, ASCollectionDelegateFlowLayout, ASCollectionGalleryLayoutPropertiesProviding>
...
@implementation ASCollectionViewVC
